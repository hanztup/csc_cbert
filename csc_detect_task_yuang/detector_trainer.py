...
@version: 1.0
@desc  : Develop function of CSC detect
"""
...
from datasets.csc_dataset import CSCDataset, DetectorDataset
from models.modeling_glycebert import GlyceBertForTokenClassification
from utils.random_seed import set_random_seed
from metrics.csc_metric import MetricForCSC
...
class CSCDetectTask(pl.LightningModule):
    def __init__(self, args: argparse.Namespace):
        ...
        self.detect_labels = CSCDataset.get_labels()
        ...
        self.ner_evaluation_metric = MetricForCSC(entity_labels=self.detect_labels, save_prediction=self.args.save_ner_prediction)
    ...
    def train_dataloader(self,) -> DataLoader:
        return self.get_dataloader("train_sighan15")

    def val_dataloader(self, ) -> DataLoader:
        return self.get_dataloader("test_sighan15")

    def _load_dataset(self, prefix="test"):
        dataset = CSCDataset(directory=self.args.data_dir,
                             prefix=prefix,
